...
zplcore/    no GUI toolkit, runs headless
  ...
  twoof5.py, postal.py, qr.py, datamatrix.py, pdf417.py
...
- Barcodes are Code 128, Code 39, EAN-13, Interleaved 2 of 5, the UPC/EAN
  ...
  PLANET and USPS Intelligent Mail), Data Matrix, PDF417 and QR; Aztec and
  GS1 DataBar are not offered yet. Data Matrix is drawn as ECC 200 whatever
